      ...
      <>
        ...
        <div className="cart-container">
          {shoppingCart.length === 0 && (
            <>
              <div>
                no items in your cart or you are not logged in
              </div>
              <div>
          ...
          {shoppingCart &&
            shoppingCart.map((cart) => (
              <div className="cart-card" key={cart.ProductID}>
                ...
                <img src={ethereum} alt='Etherum' /> 0.00{cart.ProductPrice}</div>
                ...
                <div className="cart-price"><div className="etherum">
                <img src={ethereum} alt='Etherum' />  0.00{cart.TotalProductPrice}</div>
               </div>
          ...
          {shoppingCart.length > 0 && (
            <div className="cart-summary">
              ...
              <div className="cart-summary-price">
                ...
                <div className="etherum">
                <img src={ethereum} alt='Etherum' /></div>  
                <span>0.00{totalPrice}</span>
              </div>
              <div className="cart-summary-price">
                <span>Total Qty</span>
                <span>{totalQty}</span>
